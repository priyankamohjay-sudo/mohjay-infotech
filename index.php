...
include 'includes/header.php'; ?>
      ...
      <main>
        ...
        <section class="hero-area">
          <div class="hero-area-inner">
            <div class="slide-button-bg">
              <img class="left-btn-bg" src="assets/imgs/shape/shape-26.webp" alt="image">
              <img class="right-btn-bg" src="assets/imgs/shape/shape-27.webp" alt="image">
            </div>
          ...
          <div class="container rr-container-1410">
            <div class="brand-area-inner section-spacing">
              <div class="brand-header fade-anim">
                <div class="text-wrapper">
                  <p class="text">What Technologies We Use</p>
                </div>
              </div>
        ...
        <!-- brand area end  -->
          ...
          <!-- project-5 area start -->
          <section class="project-5-area">
            <div class="project-5-area-bg">
              <img src="assets/imgs/shape/shape-4.webp" alt="image" />
            </div>
            <div class="container rr-container-1410">
              <div class="project-5-area-inner section-spacing">
                <div class="area-shape-1 img-reveal-anim">
                  <img src="assets/imgs/gallery/gallery-51.webp" alt="image" />
                </div>
                <div class="project-5-header fade-anim">
                  <div class="section-title-wrapper">
                    <div class="subtitle-wrapper">
                      <span class="section-subtitle"
                        ><span class="start-shape"></span
                ...
                <div class="project-5-wrapper-box fade-anim">
                  <div class="project-5-wrapper">
                    <div class="swiper project-5-active">
                      <div class="swiper-wrapper">
                        <!-- <div class="swiper-slide">
                    ...
                    <div class="project-5-nav">
                      <div class="project-5-button-prev project-5-nav-btn">
                        <i class="fa-solid fa-arrow-left"></i>
                      </div>
                      <div class="project-5-button-next project-5-nav-btn">
                        <i class="fa-solid fa-arrow-right"></i>
                      </div>
                    </div>
                  </div>
                  <div class="project-5-pagination"></div>
                </div>
              </div>
            </div>
          </section>
            ...
            <div class="progress-area-inner section-spacing">
              <div class="progress-thumb-wrappper fade-anim" data-direction="left">
                ...
                <div class="progress-thumb-3">
                  <img class="img-reveal-anim" src="assets/imgs/gallery/gallery-7.webp" alt="image">
                </div>
              </div>
              <div class="progress-content fade-anim" data-direction="right">
                <div class="section-title-wrapper">
                  <div class="subtitle-wrapper">
                    <span class="section-subtitle"><span class="start-shape"></span><span class="text">Why Choose Us</span><span class="end-shape"></span></span>
                  </div>
                  <div class="title-wrapper">
                    <h2 class="section-title">Transforming Your Success Through</h2>
                  </div>
                </div>
                <div class="text-wrapper">
                  <p class="text">Partner with a forward-thinking IT software company to implement intelligent automation and custom software solutions that make your business run more smoothly, cut costs, and improve performance in ways that can be measured.</p>
                </div>
                <div class="progress-wrapper-box">
                  <div class="progress-wrapper">
                    <div class="progress-box">
                      <div class="progress-title">
                        <h3 class="progress-category">Measurable Performance Optimization</h3>
                        <span>65%</span>
                      </div>
                      <div class="progress">
                    ...
                    <div class="progress-box">
                      <div class="progress-title">
                        <h3 class="progress-category">Application of Intelligent Automation</h3>
                        <span>88%</span>
                      </div>
                      <div class="progress">
                    ...
                    <div class="progress-box">
                      <div class="progress-title">
                        <h3 class="progress-category">Integrating Custom Software</h3>
                        <span>90%</span>
                      </div>
                      <div class="progress">
            ...
            <div class="process-area-inner section-spacing">
              <div class="process-header fade-anim">
                <div class="section-title-wrapper">
                  ...
                  <div class="title-wrapper">
                    <h2 class="section-title">Expert-Led Software Implementation Support</h2>
                  </div>
                </div>
              </div>
              <div class="process-wrapper-box fade-anim">
                <div class="process-wrapper">
                  <div class="process-box">
                    ...
                    <div class="content">
                      <h3 class="title">Optimized User Experience</h3>
                      <p class="text">Usability, engagement, satisfaction, performance, and retention are all improved by an optimized user experience.</p>
                    </div>
                  </div>
                  <div class="process-box">
                    <img class="shape-start" src="assets/imgs/shape/shape-2.webp" alt="image">
                    <img class="shape-end" src="assets/imgs/shape/shape-2.webp" alt="image">
                    <div class="thumb">
                      <img src="assets/imgs/icon/icon-6.webp" alt="image">
                    </div>
                    <div class="content">
                      <h3 class="title">Branding & Conversion</h3>
                      <p class="text">While optimized conversions maximize quantifiable growth, strategic branding fortifies identity.</p>
                    </div>
                  </div>
                  <div class="process-box">
                    <div class="thumb">
                    ...
                    <div class="content">
                      <h3 class="title">Transforming Success</h3>
                      <p class="text">Transforming success via strategy, innovation, quantifiable expansion, and consistent excellence.</p>
                    </div>
                  </div>
                </div>
              </div>
     ...
     <!-- cta area stat  -->
        ...
        <!-- blog-3 area start  -->
          <section class="blog-3-area">
            <div class="blog-3-bg">
              <img src="assets/imgs/shape/shape-20.webp" alt="image" />
            </div>
            <div class="container rr-container-1410">
              <div class="blog-3-area-inner section-spacing">
                <div class="area-shape-1">
                  <img src="assets/imgs/shape/shape-21.webp" alt="image" />
                </div>
                <div class="blog-3-content fade-anim">
                  <div class="section-title-wrapper">
                    <div class="subtitle-wrapper">
                      <span class="section-subtitle"
                        ><span class="start-shape"></span
                    ...
                    <div class="title-wrapper">
                      <h2 class="section-title">
                        Our Latest News & Blog Updates
                      </h2>
                    </div>
                  </div>
                  <div class="text-wrapper">
                    <p class="text">
                      Our global marketing expertise, advanced supply chain
                      technology & customized SEO solutions will help you
